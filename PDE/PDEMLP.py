        ...
        if DIM ==2:
            ...
            for grid in grids:
                ...
                for ep in range(step):
                    ...
                    # save loss curves
        np.savetxt(f'l2loss_dim_{DIM}_frequency_{FREQUENCY}_model_{model_choice}.txt', np.array(true_losses_l2))
        np.savetxt(f'h1loss_dim_{DIM}_frequency_{FREQUENCY}_model_{model_choice}.txt', np.array(true_losses_h1))
